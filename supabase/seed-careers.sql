-- Catálogo de carreras FPUNA (Facultad Politécnica — San Lorenzo).
-- IDs deterministas (stableUuid) — deben coincidir con el importador.
-- Ejecutar después de reset-academic-data.sql si aún no importaste el Excel.
